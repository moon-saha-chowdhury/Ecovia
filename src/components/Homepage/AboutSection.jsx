    ...
    <>
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="bg-gray-100 flex flex-col items-center p-6 md:p-8 w-full lg:w-1/3 text-center">
          ...
          {/* Projects */}
          <div className="mt-4 text-left w-full">
            <h3 className="font-semibold text-gray-900 mb-1">LEED PROJECTS</h3>
            <ul className="text-sm text-gray-700 space-y-1">
              <li>DBL Group</li>
              <li>PANAM Group</li>
              <li>MASCO Group</li>
        ...
        <div className="p-6 md:p-10 w-full lg:w-2/3 space-y-6">
          ...
          <p className="text-gray-700 text-sm md:text-base leading-relaxed">
            ...
            projects for a green building consulting firm. As required by LEED,
            I support industry specialists in enhancing water and energy
          ...
          <p className="text-gray-700 text-sm md:text-base leading-relaxed">
            I oversee over twenty green building projects. Three of these ranked
            among the world's top ten green buildings, with seven achieving
            Platinum certification, five earning Gold, while the rest are still
            in progress.
          </p>
          <p className="text-gray-700 text-sm md:text-base leading-relaxed">
            I enjoy sharing my knowledge with professionals who want to work in
            sustainability by offering training on LEED and Higg V4, as well as
            consulting on LEED Green Building Certification, Green Finance, and
            the Higg Index for the garment industry.
          </p>
