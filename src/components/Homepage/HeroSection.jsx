...
const HeroSection = () => {
  return (
    <section className="pb-[55px] md:pb-[68px] lg:pb-[80px] pt-[60px] bg-[#d7d7d7]">
      <div className="ev-container">
        <div className="lg:py-[125px] pt-[60px] w-full  mx-auto flex flex-col  md:gap-[25px] gap-[15px] relative z-10">
          {/* <div className="absolute inset-0 bg-[url('/assets/images/BgImage.png')] bg-contain  bg-[position:center_100px] bg-no-repeat z-[-2] opacity-12" /> */}
          ...
          <div className="btn-container flex gap-[15px] items-center justify-center">
            <Link href={"/"}>
              <button className="p-[7px] lg:p-[15px] bg-[#8acbcf] rounded-[25px] grid grid-cols-[auto_5px] items-center gap-[5px] cursor-pointer">
                <span className="btn-lbl text-[#12383d] text-[12px] sm:text-[14px] md:text-[16px] font-medium">
                  Start a Session Now
                </span>
            ...
            <Link href={"/#about"}>
              <button className="p-[7px] lg:p-[10px] border border-[#143d3c] rounded-[4px] text-[#143d3c] text-[12px] sm:text-[14px] md:text-[16px] font-medium cursor-pointer">
                Inside Ecovia
              </button>
            </Link>
          </div>
