...
const HeroSection = () => {
  return (
    <section className="pb-[55px] md:pb-[68px] lg:pb-[80px] pt-[60px]">
      <div className="ev-container">
        <div className="lg:py-[125px] pt-[60px] w-full  mx-auto flex flex-col  md:gap-[25px] gap-[15px] relative z-10">
          ...
          <div className="btn-container flex gap-[15px] items-center justify-center">
            <Link href={"/"}>
              <button className="p-[7px] lg:p-[10px] bg-[#22603f] rounded-[4px] grid grid-cols-[auto_5px] items-center gap-[5px] cursor-pointer">
            ...
            <Link href={"/#about"}>
              <button className="p-[7px] lg:p-[10px] border border-[#22603f] rounded-[4px] text-[#22603f] text-[12px] sm:text-[14px] md:text-[16px] cursor-pointer">
                Inside Ecovia
              </button>
            </Link>
          </div>
